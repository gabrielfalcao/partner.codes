...
from partner_codes import logs
from partner_codes.dao import json
from partner_codes.web.schemas import json_response
from partner_codes.dao import FileStorage
from partner_codes.dao import S3Storage
from partner_codes.version import version
from partner_codes.web.logs import logger
from partner_codes.web.controllers import ControllerException
...
class ApplicationContainer(Flask):
    ...
    def __init__(self, *args, **params):
        ...
        super(ApplicationContainer, self).__init__('partner_codes.web', *args, **params)
    ...
    def auto_configure(self):
        ...
        """
        varname = '__PARTNER_CODES_DISABLE_AUTOCONFIG'
    ...
    def configure_dao(self):
        ...
        1. :py:class:`~partner_codes.dao.s3.S3Storage`
        2. :py:class:`~partner_codes.dao.files.FileStorage`
        """
