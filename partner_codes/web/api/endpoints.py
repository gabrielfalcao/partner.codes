...
from partner_codes.web.schemas import JsonSchemaHttpPair
...
api_v1 = api.namespace(
    'api_v1',
    description='Partner Codes API v1',
    path='/api/v1'
)
...
class Projects(Resource):
    ...
    - controller: :py:class:`~partner_codes.web.api.controllers.ProjectController`
    """
