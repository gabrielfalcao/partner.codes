...
class ActiveRecord(OrderedDict):
    ...
    **always** bound to a :py:class:`~Storage` object.
    ...
    :param __dao__: a :py:class:`~partner_codes.dao.base.Storage` instance.
    ...
    def with_dao(self, dao):
        ...
        pointing to another
        :py:class:`~partner_codes.dao.base.Storage` instance.

        :param dao: an instance of :py:class:`~partner_codes.dao.base.Storage`
    ...
    def save(self, key):
        ...
        This is really just a **shortcut** to :py:meth:`~partner_codes.dao.base.Storage.persist` on
    ...
    def delete(self, key):
        ...
        This is really just a **shortcut** to :py:meth:`~partner_codes.dao.base.Storage.delete` on
        the DAO in which this **ActiveRecord** is bound to.
    ...
    def from_path(cls, path, dao):
        ...
        :param dao: an instance of :py:class:`~partner_codes.dao.base.Storage` most likely a subclass
        :returns: an :py:class:`~partner_codes.dao.base.ActiveRecord`
        """
...
class Storage(object):
    ...
    :py:class:`~partner_codes.dao.base.Storage`
    """
    ...
    def clone(self, namespace):
        ...
        :py:class:`~partner_codes.dao.base.Storage`, pointing
    ...
    def new(self, **kw):
        """creates a new :py:class:`~partner_codes.dao.base.ActiveRecord` with the given
        keyword-args"""
