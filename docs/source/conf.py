...
module_path = project_path.joinpath('partner_codes')

admin_app_path = project_path.joinpath('frontend/admin-app')
react_source_path = admin_app_path.joinpath('src')

os.environ['PARTNER_CODES_CONF_PATH'] = str(project_path.joinpath('tests/functional/functional-test-config.yaml'))
sys.path.insert(0, project_path.as_posix())

from partner_codes.version import version  # noqa
# -*- coding: utf-8 -*-
#
...
project = 'Partner Codes'
copyright = '2018, Gabriel and JJ'
author = 'Gabriel and JJ'
...
htmlhelp_basename = 'PartnerCodesdoc'
...
latex_documents = [
    (master_doc, 'PartnerCodes.tex', 'Partner Codes Documentation',
     'Gabriel and JJ', 'manual'),
]
...
man_pages = [
    (master_doc, 'partnercodes', 'Partner Codes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PartnerCodes', 'Partner Codes Documentation',
     author, 'PartnerCodes', 'One line description of project.',
     'Miscellaneous'),
]
