...
def read_version():
    scope = {}
    exec(local_file('partner_codes/version.py'), scope)
...
setup(
    ...
    entry_points={
        'console_scripts': ['partner-codes = partner_codes.console:entrypoint'],
    },
    package_data=dict([
        ('partner_codes', DATA_EXTENSIONS),
        ('partner_codes.web.ui', DATA_EXTENSIONS),
        ('partner_codes.web.schemas.adapter', '*.json'),
        ('partner_codes.web.schemas.provider', '*.json'),
    ]),
    zip_safe=False,
)
