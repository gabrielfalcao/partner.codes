...
import shutil
import httpretty
import partner_codes
from pathlib import Path
from sure import scenario

from partner_codes import aws
from partner_codes.util import DateEngine
from partner_codes import application
...
documentation_path = Path(partner_codes.__file__).parent.parent.joinpath('docs/source/api/v1')
